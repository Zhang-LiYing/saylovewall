<?php
  ...
  class sendEmail
  {
    ...
    public function sendOut($linkDatabaese, $uid, $email)
    {
      ...
      $mail->Password = 'qq邮箱密码';                           // SMTP password 这里需要QQ邮箱开启独立密码并填写到这里
      ...
      $mail->setFrom('QQ账号@qq.com', '广西科技大学2016表白墙');// 填写发送人的邮箱，和主题标题
      $mail->addAddress("{$email}");               // Name is optional 对方的邮件地址
      $mail->addReplyTo('QQ账号@qq.com', '广西科技大学2016表白墙'); // 填写回复的邮箱，和主题标题

      //$mail->addAttachment('/var/tmp/file.tar.gz');         // Add attachments
      //$mail->addAttachment('/tmp/image.jpg', 'new.jpg');    // Optional name
      $mail->isHTML(true);                                  // Set email format to HTML

      $mail->Subject = '你被表白啦！来自广西科技大学表白墙';// 邮件的标题
